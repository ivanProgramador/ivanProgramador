...
- REACT,NEXT JS, VUE, LARAVEL(ELOQUENT, BLADE, FLUENT(QUERY BUILDER),COMPOSER,MAILROG), ANGULAR, BOOTSTRAP, BULMA, EXPRESS, SEQUELIZE, AXIOS, BODY-PARSER, CORS, MYSQL2, KNEX, EJS, WEB SOCKET,MONGOOSE,FULL CALENDAR, TAIL WIND, REACT NATIVE.
